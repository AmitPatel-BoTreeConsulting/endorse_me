...
Devise.setup do |config|
  ...
  # config.pepper = "e9400d064cdc7c1cad4b7c7b07359ff1143a9c9a6d01affedb327ea65531662d43c7cd7e24a214097d47895c7cb4918a54690e6dad1348202b63ec4200bb410c"
  ...
  config.omniauth :twitter, 'aEMfOq6A2KiSbcnB3DwPqg', 'oqa7hZlmqr6BZ1SowhwGsa7UR6lfFn2kDWudjTkmeE', :strategy_class => OmniAuth::Strategies::Twitter
  config.omniauth :linkedin, '65kymfy9dsne', '14ElorTGNRTd0ecm', { :scope => "r_fullprofile r_network", :fields=> ["id", "email-address", "first-name", "last-name", "headline", "industry", "picture-url", "public-profile-url", "location", "connections"] }
